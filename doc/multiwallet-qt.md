...
In order to support loading of multiple wallets in carbonzero-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is carbonzero.cpp.
...
Changes to carbonzero.cpp
----------------------
carbonzero.cpp is the entry point into carbonzero-qt, and as such, will require some minor modifications to provide hooks for
