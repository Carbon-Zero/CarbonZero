...
This mechanism has been integrated into Bitcore-Node-CarbonZero which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/CarbonZero-Project/insight-api-carbonzero#web-socket-api](https://github.com/CarbonZero-Project/insight-api-carbonzero#web-socket-api) 
* API: [https://github.com/CarbonZero-Project/insight-api-carbonzero#swifttx-transactions](https://github.com/CarbonZero-Project/insight-api-carbonzero#swifttx-transactions) 
...
By default, the CarbonZero Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CarbonZero Core daemon:
