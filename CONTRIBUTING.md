Contributing to CarbonZero Core
============================

The CarbonZero Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CarbonZero Core project, and is not to be
confused with overall CarbonZero Network Protocol consensus changes.

Whether a pull request is merged into CarbonZero Core rests with the project merge
...
Patches that change CarbonZero consensus rules are considerably more involved than
...
Where a patch set proposes to change the CarbonZero consensus, it must have been
...
The project leader is the release manager for each CarbonZero Core release.
