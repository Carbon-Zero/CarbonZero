...
static const unsigned int MAX_ZEROCOIN_TX_SIZE = 400000; // from 150k
...
static const int MAX_BLOCKS_IN_TRANSIT_PER_PEER = 512; //from 128
...
static const unsigned int BLOCK_DOWNLOAD_WINDOW = 4096; //from 1024
