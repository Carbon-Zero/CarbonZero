...
CAmount CBudgetManager::GetTotalBudget(int nHeight)
{
    ...
    CAmount nSubsidy = 0;
      if (nHeight == 0) {
        ...
        nSubsidy = 500000 * COIN;
    } else if (nHeight > 0 && nHeight <= 40000) {
        nSubsidy = 0.25 * COIN;
    } else if (nHeight > 40000 && nHeight <= 140000) {
        nSubsidy = 0.7 * COIN;
    } else if (nHeight > 140000 && nHeight <= 240000) {
        nSubsidy = 0.8 * COIN;
    } else if (nHeight > 240000 && nHeight <= 340000) {
        nSubsidy = 0.9 * COIN;
    } else if (nHeight > 340000 && nHeight <= 440000) {
        nSubsidy = 1 * COIN;
    } else if (nHeight > 440000 && nHeight <= 540000) {
        nSubsidy = 1.25 * COIN;
    } else if (nHeight > 540000 && nHeight <= 640000) {
        nSubsidy = 1.5 * COIN;
    } else if (nHeight > 640000 && nHeight <= 740000) {
        nSubsidy = 1.75 * COIN;
    } else if (nHeight > 740000 && nHeight <= 840000) {
        nSubsidy = 2 * COIN;
    } else if (nHeight > 840000 && nHeight <= 940000) {
        nSubsidy = 2.25 * COIN;
    } else if (nHeight > 940000 && nHeight <= 1000000) {
        nSubsidy = 2.5 * COIN;
