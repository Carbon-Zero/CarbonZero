                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    // It doesn't make sense to show the checkbox for sending CO2 because you wouldn't check it anyway.
    if (context == Context::Send_CO2 || context == Context::Send_zcarbon) {
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
            tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR CO2</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
                    ...
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                        "<qt>" +
                            tr("CarbonZero will close now to finish the encryption process. "
                               ...
                               "your CO2s from being stolen by malware infecting your computer.") +
                            "<br><br><b>" +
