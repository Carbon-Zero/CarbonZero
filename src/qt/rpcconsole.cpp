                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzcarbonPathCustom = GetArg("-zcarbonbackuppath", "");
    ...
    if(!strzcarbonPathCustom.empty()) {
        ui->wallet_customzcarbonbackuppath->setText(QString::fromStdString(strzcarbonPathCustom));
        ui->wallet_customzcarbonbackuppath_label->setVisible(true);
        ui->wallet_customzcarbonbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzcarbonPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the CarbonZero RPC console.") + "<br>" +
