...
/* CarbonZero GUI -- Size of icons in status bar */
...
#define COLOR_UNCONFIRMED QColor(51, 66, 75)
/* Transaction list -- negative amount */
#define COLOR_NEGATIVE QColor(215, 38, 61)
/* Transaction list -- bare address (without label) */
#define COLOR_BAREADDRESS QColor(79, 95, 105)
...
#define COLOR_STAKE QColor(87,96,109)
...
#define QAPP_ORG_NAME "CarbonZero"
#define QAPP_ORG_DOMAIN "carbonzero.org"
#define QAPP_APP_NAME_DEFAULT "CarbonZero-Qt"
#define QAPP_APP_NAME_TESTNET "CarbonZero-Qt-testnet"
