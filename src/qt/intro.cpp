...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("CarbonZero Core"),
     ...
     * override -datadir in the carbonzero.conf file in the default data directory
     * (to be consistent with carbonzerod behavior)
     */
    if (dataDir != getDefaultDataDirectory())
