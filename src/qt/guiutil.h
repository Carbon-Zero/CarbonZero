...
/** Utility functions used by the CarbonZero Qt UI.
 */
namespace GUIUtil
{
...
// Render CarbonZero addresses in monospace font
...
// Parse "carbonzero:" URI into recipient object, return true on successful parsing
