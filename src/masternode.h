...
#define MASTERNODE_REMOVAL_SECONDS (13 * 60)
...
//
// The Masternode Class. For managing the Obfuscation process. It contains the input of the 10000 CO2, signature to prove
