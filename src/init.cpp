...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-reindexmoneysupply", _("Reindex the BCZ and zcarbon money supply statistics") + " " + _("on startup"));
    ...
    strUsage += HelpMessageOpt("-pivstake=<n>", strprintf(_("Enable or disable staking functionality for BCZ inputs (0-1, default: %u)"), 1));
...
//    strUsage += "  -anonymizecarbonzeroamount=<n>     " + strprintf(_("Keep N BCZ anonymized (default: %u)"), 0) + "\n";
