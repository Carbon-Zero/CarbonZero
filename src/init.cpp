...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-reindexmoneysupply", _("Reindex the BTCZ and zcarbon money supply statistics") + " " + _("on startup"));
    ...
    if (GetBoolArg("-help-debug", false))
        strUsage += HelpMessageOpt("-mintxfee=<amt>", strprintf(_("Fees (in BTCZ/Kb) smaller than this are considered zero fee for transaction creation (default: %s)"),
            FormatMoney(CWallet::minTxFee.GetFeePerK())));
    strUsage += HelpMessageOpt("-paytxfee=<amt>", strprintf(_("Fee (in BTCZ/kB) to add to transactions you send (default: %s)"), FormatMoney(payTxFee.GetFeePerK())));
    ...
    strUsage += HelpMessageOpt("-minrelaytxfee=<amt>", strprintf(_("Fees (in BTCZ/Kb) smaller than this are considered zero fee for relaying (default: %s)"), FormatMoney(::minRelayTxFee.GetFeePerK())));
    ...
    strUsage += HelpMessageOpt("-pivstake=<n>", strprintf(_("Enable or disable staking functionality for BTCZ inputs (0-1, default: %u)"), 1));
...
//    strUsage += "  -anonymizecarbonzeroamount=<n>     " + strprintf(_("Keep N BTCZ anonymized (default: %u)"), 0) + "\n";
...
//    if (nAnonymizeCarbonZeroAmount < 2) nAnonymizeCarbonZeroAmount = 2;
    ...
    /* Denominations
       ...
       For example:
       1BTCZ+1000 == (.1BTCZ+100)*10
       10BTCZ+10000 == (1BTCZ+1000)*10
    */
