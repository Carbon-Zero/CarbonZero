...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CarbonZero Core carbonzero-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  carbonzero-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded carbonzero transaction") + "\n" +
                               "  carbonzero-tx [options] -create [commands]   " + _("Create hex-encoded carbonzero transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded carbonzero transaction
