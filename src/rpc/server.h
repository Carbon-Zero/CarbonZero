...
/**
 * CarbonZero RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzcarbonseed(const UniValue& params, bool fHelp);
extern UniValue getzcarbonseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzcarbon(const UniValue& params, bool fHelp);
extern UniValue dzcarbonstate(const UniValue& params, bool fHelp);
